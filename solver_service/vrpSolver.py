...
def get_solution_info(data, manager, routing, solution):
    """Returns solution information as a dictionary."""
    solution_data = {
    ...
    solution_data["Maximum_route_distance"] = max_route_distance
...
def main(inputData):
    ...
    input_file = inputData['input_file']
    #os.path.abspath(sys.argv[1])  # Get absolute path
    num_vehicles = inputData['num_vehicles']
    #int(sys.argv[2])
    depot = inputData['depot']
    #int(sys.argv[3])
    max_distance = inputData['max_distance']
    #int(sys.argv[4])
    # Read JSON file
...
# Create the routing index manager.
    ...
    if solution:
        ...
        return get_solution_info(data, manager, routing, solution)
